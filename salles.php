...
<?php
    ...
    <h1 class="text-center border">Liste des salles disponibles</h1>
    ...
    ?>
    <tr onclick="getSalle(<?=$value['Num_S']?>)">
    <td > <?=$value['Num_S']?></td>
...
<script>
    function getSalle(val){
        document.location.href="salle.php?id="+val+"&jeton=<?=$_SESSION['jeton']?>";
    }
</script>
</body>
</html>
